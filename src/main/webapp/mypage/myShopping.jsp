...
<!--===============================================================================================-->
<style>
	.tab_menu {display:table; table-layout:fixed; border:2px solid #ededed; margin-top: 120px; padding: 10px 0;}
	.tab_menu li{display:table-cell;cursor:pointer}
	.tab_menu li img{vertical-align:middle; width: 180px;}
	.tab_menu li{background:#fff; width: 100px; height: 60px; vertical-align: middle;}
	.tab_menu li.on{background:#fff; color: #f8d115;}
	.tab_menu li+li{border-left:none}
	.tab_menu li {border: none;}
	
	.tab_content td{width: 150px; display: inline-block;}
	
	.how-i {margin-top: 20px;}
...
<div class="cate_tab">
        ...
        <ul class="tab_menu">
            ...
            <li data-tab="tab-1">결제완료<br>
            <a class="on">1</a>
            </li>
            <li style="width: 20px;">
            <img src="${pageContext.request.contextPath}/images/icons/arrow_right.png" 
            	alt="" style="width: 10px;">
            </li>
            <li data-tab="tab-2">배송중<br>
            <a>2</a>
            </li>
             <li style="width: 20px;">
             <img src="${pageContext.request.contextPath}/images/icons/arrow_right.png" 
    ...
    <li id="tab-1" class="on">
	    <table>
		     <tr class="tab_content">
				...
				<td class="column-6"><button style="color: #96aac1; font-weight: bold;">삭제</button></td>
			</tr>
		</table>
    </li>
    <li id="tab-2">
