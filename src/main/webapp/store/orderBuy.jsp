	...
	$(function() {
		...
		$("#kakaopyBtn").click(function() {
			...
			IMP.request_pay({
				...
				name : '상품명',
				amount : '${sessionScope.totalprice}', //총판매가격
						...
						<section class="user_info">
							<div style="display: block;">
								...
								<div class="user_name" style="padding: 10px 0px 20px 0px;">
									<div
										style="float: left; margin-right: 28px; padding: 2.2px 0px">닉네임</div>
								...
								<div class="user_addr" style="padding: 10px 0px 20px 0px;">
									<div
										style="float: left; margin-right: 28px; padding: 2.2px 0px">이메일</div>
								...
								<div class="give_name" style="padding: 10px 0px 20px 0px;">
									<div
										style="float: left; margin-right: 14px; padding: 2.2px 0px">휴대전화</div>
									<input class="deftext" type="text" name="buy_name"
								...
								<div class="order_product_wrap">
									...
									<div class="user_product">
										...
										<div
											...
											<span>${map.value.product.price}</span> <span style="padding: 0px 10px;">|</span> <span>${map.value.odrerQty}개</span>
										</div>
									</div>
								</div>
								</div>
									...
									<form>
										<div class="cntr">
											<label for="cbx" class="label-cbx"> <input id="cbx"
												...
												</div> <span style="float: left; font-family: SCDream5">카카오페이</span>
											</label>
										</div>
									</form>
								</div>
			...
			<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
				<div
					...
					<div class="flex-w flex-t bor12 p-b-13">
						<div class="size-208">
							<span class="stext-110 cl2"> 총 상품금액: </span>
						</div>

						<div class="size-209">
							<span class="mtext-110 cl2"> ${sessionScope.totalprice} 원
							</span>
						</div>
					</div>
					...
					<div class="flex-w flex-t p-t-27 p-b-33">
						<div class="size_font" style="font-family: SCDream6;">
							...
							<div class="paytext" style="font-family: SCDream4; color: #000;">
								<b
									style="font-family: SCDream6; color: #0f42e9; font-size: 20px;">${sessionScope.totalprice}</b>원
							</div>
						</div>
					...
					<button
						...
						style="font-family: SCDream4; font-size: 18px;" id="kakaopyBtn">결제하기</button>
				</div>
			</div>
		</div> 
</body>
