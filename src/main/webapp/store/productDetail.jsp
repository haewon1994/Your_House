							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="${pageContext.request.contextPath}/images/product-detail-03.jpg">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/bed-product01-detail-03.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#description" role="tab">상품상세설명</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#information" role="tab">상품정보</a>
						</li>
										...
										<form class="w-full">
											...
											<div class="row p-b-25">
												<div class="col-12 p-b-5">
													<label class="stext-102 cl3" for="review">이 상품을 얼마나 만족하시나요?</label>
													<input class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10" id="review" name="review" placeholder="최소 10자 이상 작성해주세요." style="font-size: 12px;"></input>
												</div>
