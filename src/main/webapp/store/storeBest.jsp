...
<!--===============================================================================================-->
	<style>
		...
		.tab_menu li{background:#ededed; width: 100px; height: 60px; vertical-align: middle;}
		.tab_menu li.on{background:#1049af; color:#fff;}
					...
					<div class="block3">
						...
						<div class="block3-txt flex-w flex-t p-t-14">
							<div class="product_col">
								<a href="product-detail.html" class="product_name">
									Esprit Ruffle Shirt
								</a>
